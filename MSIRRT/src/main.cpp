...
int main(int argc, char **argv)
{
    ...
    path_result.AddMember("start_tree_active_vertices", static_cast<uint64_t>(plannerConnect.get_start_tree_active_vertices_count()), MDP::ResultsWriter::get_instance().get_json_allocator());
    path_result.AddMember("goal_tree_active_vertices", static_cast<uint64_t>(plannerConnect.get_goal_tree_active_vertices_count()), MDP::ResultsWriter::get_instance().get_json_allocator());
    path_result.AddMember("planning_horizon_frame", plannerConnect.get_planning_horizon_frame(), MDP::ResultsWriter::get_instance().get_json_allocator());
    path_result.AddMember("evaluated_samples", static_cast<uint64_t>(plannerConnect.get_evaluated_samples()), MDP::ResultsWriter::get_instance().get_json_allocator());
    path_result.AddMember("conditionally_rejected_samples", static_cast<uint64_t>(plannerConnect.get_conditionally_rejected_samples()), MDP::ResultsWriter::get_instance().get_json_allocator());
    path_result.AddMember("conditionally_bypassed_samples", static_cast<uint64_t>(plannerConnect.get_conditionally_bypassed_samples()), MDP::ResultsWriter::get_instance().get_json_allocator());
    path_result.AddMember("proposed_samples", static_cast<uint64_t>(plannerConnect.get_proposed_samples()), MDP::ResultsWriter::get_instance().get_json_allocator());
